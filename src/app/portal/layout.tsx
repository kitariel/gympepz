...
import { SyncProgramsTrigger } from "@/components/sync/SyncProgramsTrigger";
        ...
        <ProfileSidebarProvider>
          ...
          <SidebarInset className="border-none! ring-0 shadow-slate-200! flex-1 min-w-0 max-w-full">
            ...
            <div className="flex flex-1 flex-col overflow-hidden w-full max-w-full">
              <div className="flex-1 overflow-y-auto overflow-x-hidden w-full max-w-full min-w-0 pb-24 md:pb-0">
                {children}
              </div>
            </div>
          </SidebarInset>
