          ...
          <div className="container mx-auto px-4 sm:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8 sm:text-xl">
                ...
                goals with our intelligent fitness companion. Granular tracking
          ...
          <div className="container mx-auto px-4 sm:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="text-muted-foreground mt-6 text-lg leading-8">
                Stop guessing. Start tracking. Our tools help you visualize your
                improvements and plan your next move.
              </p>
            </div>
            <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
              <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3">
                {/* Feature 1 */}
                <div className="bg-card flex flex-col rounded-2xl border p-8 shadow-sm transition-all hover:shadow-md">
        ...
        <section className="py-24 sm:py-32">
          <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="bg-card rounded-xl border p-6 shadow-sm sm:col-span-2">
              ...
              <div className="bg-card rounded-xl border p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400">
              ...
              <div className="bg-card rounded-xl border p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400">
