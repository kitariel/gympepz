...
function scoreTemplate(profile: UserTrainingProfile, template: ProgramTemplate): Scored<ProgramTemplate> {
  let score = 0;
...
export function recommendTemplates(profile: UserTrainingProfile, templates: ProgramTemplate[]): ProgramTemplate[] {
