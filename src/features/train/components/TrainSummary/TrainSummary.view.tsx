...
import type { SummaryViewProps } from "./TrainSummary.types";
...
export function TrainSummaryView(props: SummaryViewProps) {
  if (props.state === "loading") {
    return (
      <TrainShell className="space-y-4">
