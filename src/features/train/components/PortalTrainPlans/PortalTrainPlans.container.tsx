...
import { PortalTrainPlansView } from "./PortalTrainPlans.view";

function nowIso(): string {
  return new Date().toISOString();
}

export function PortalTrainPlans() {
  ...
  return (
    <PortalTrainPlansView
      hydrated={hydrated}
      items={items}
      createHref="/portal/train/build"
      backHref="/portal/train"
      getEditHref={(id) => `/portal/train/build?id=${encodeURIComponent(id)}`}
      onUse={handleUse}
