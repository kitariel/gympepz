...
import type { SummaryMetrics, SummaryViewProps } from "./PortalTrainSummary.types";
import { PortalTrainSummaryView } from "./PortalTrainSummary.view";
...
export function PortalTrainSummary() {
  ...
  if (!hydrated || !programHydrated) {
    ...
    viewProps = {
      ...
      overviewHref: "/portal/train/overview",
    };
  } else {
    const dayLabel =
    ...
    viewProps = {
      ...
      onRepeat:
        item.programDayIndex
          ? () =>
              router.push(
                `/portal/train/log?day=${item.programDayIndex}&autostart=1`,
              )
          : undefined,
      homeHref: "/portal/train",
      historyHref: "/portal/train/history",
    };
  }

  return <PortalTrainSummaryView {...viewProps} />;
}
